...
The owner approved local EULA acceptance, private offline clients, host-only administration and pending judge review. Offline UUID consistency does not authenticate a person. Native source-audit recommendations about UUID-granted administrators in SOURCE_MAP.md predate this policy and must not be implemented; native facts remain applicable.
